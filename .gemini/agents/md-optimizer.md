---
name: md-optimizer
description: Use this agent when user wants to review, optimize, or upgrade an agent definition (.gemini/agents/*.md) or skill definition. Analyzes files, researches best practices, proposes before/after changes, waits for confirmation before writing.
