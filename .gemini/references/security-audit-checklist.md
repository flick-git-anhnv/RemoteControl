...
> Tách từ `.gemini/commands/security-audit-stride.md` (§5 đề xuất cải tiến — nghiên cứu `addyosmani/agent-skills`, xem `docs/research/RESEARCH-agent-skills-2026-07-12.md`). File này là nguồn chi tiết duy nhất — `security-audit-stride.md` link tới đây thay vì lặp lại nội dung.
...
## Cách dùng
1. Người thực hiện `security-audit-stride` copy 2 bảng trên thành checklist `- [ ]` khi audit thực tế (xem format ở `.gemini/commands/security-audit-stride.md`).
